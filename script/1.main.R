source("/picb/sysgenomics2/people/liuhengxin/P6_lineartree/myscript/scarscript/v3.0/1.scar_function.R")
...
CallScar = function(INDEL,Scar,scarref,scarfull,scar,cln){
  print("Scar to INDEL Range...")
  data = INDELChangeForm(INDEL,Scar,scarref,".",cln)
  print("Done")
...
if(command == "PreData1"){
  ...
  sv = ReadFasta(files["Fasta"])
  scarfull = sv$scarfull
  CallScar(INDEL,Scar,scarref,scarfull,scar,cln)
  ...
  CallScar(INDEL,Scar,scarref1,scarfull1,scar1,cln)
  ...
  scarfull = sv$scarfull1
  CallScar(INDEL,Scar,scarref2,scarfull2,scar2,cln)
